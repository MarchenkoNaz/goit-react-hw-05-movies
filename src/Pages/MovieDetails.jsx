		...
		<>
			...
			{movie && <div>
				...
				<div className='d-flex flex-wrap'>
					<img src={movie.poster_path ? getImagesFromApi(movie.poster_path) : defaultAvatar} width={220} height={320} alt={movie.title} />
					<div className='description ms-4'>
						...
						{movie.status && <div className='releases '>
				...
				<ul className='d-flex'>
					<li className='m-2 btn btn-dark'>
						<Link to={`/movies/${params.id}/cast`} state={location.state}>Cast</Link>
					</li>
					<li className='m-2 btn btn-dark'>
						<Link to={`/movies/${params.id}/reviews`} state={location.state}>Reviews</Link>
					</li>
				</ul>
				<Outlet />
			</div >
